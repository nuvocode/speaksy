# Speaksy — Proje İskeleti & Frontend Build Prompt

## Görev
Aşağıdaki spesifikasyona göre **Speaksy** adlı açık kaynak İngilizce konuşma pratiği uygulamasının **tam proje iskeletini** ve **eksiksiz frontend kodunu** yaz. Kod çalışır durumda, production-grade ve tutarlı olmalı.
...
Speaksy'nin tasarım dili şu prensiplere dayanır:
...
"Speaksy" — "Speak" kısmı `var(--font-display)` Fraunces ile, "sy" kısmı küçük bir badge görünümünde `var(--color-accent)` arka planlı.
